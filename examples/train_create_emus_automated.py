...
# extract land
tas, _, ls = extract_land(tas_g, wgt=wgt_g, ls=ls, threshold_land=cfg.threshold_land)
...
for esm in esms:
    ...
    print("- Prepare predictors for global variability, local trends and variability")
