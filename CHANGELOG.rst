...
- Added example notebooks for calibrating on multiple scenarios and ensemble members and emulating multiple scnearios (`#521 <https://github.com/MESMER-group/mesmer/pull/521>`_).
