...
def assert_params_allclose(
    ...
    local_forced_params = local_forced_params.set_index(sample=("time", "member", "scenario"))
    exp_local_forced_params = exp_local_forced_params.set_index(sample=("time", "member", "scenario"))
