...
def test_validate_coefficients():
    ...
    expr = Expression("truncnorm(loc=c1 * __tas__, scale=c2, a=-10, b=10)", expr_name="exp1",
    ...
    coeffs_in_bounds, params_in_bounds, params_in_support, test_proba, params = _validate_coefficients(expr, pred, targ, coeffs, thresh)
    ...
    coeffs_in_bounds, params_in_bounds, params_in_support, test_proba, params = _validate_coefficients(expr, pred, targ, coeffs_out_of_bounds, thresh)
    ...
    coeffs_in_bounds, params_in_bounds, params_in_support, test_proba, params = _validate_coefficients(expr, pred_out_of_bounds, targ, coeffs, thresh)
    ...
    coeffs_in_bounds, params_in_bounds, params_in_support, test_proba, params = _validate_coefficients(expr, pred, targ_out_of_support, coeffs, thresh)
    ...
    coeffs_in_bounds, params_in_bounds, params_in_support, test_proba, params = _validate_coefficients(expr, pred, targ_low_prob, coeffs, thresh)
    assert coeffs_in_bounds is True
    assert params_in_bounds is True
    assert params_in_support is True
    ...
    thresh_none = None
    coeffs_in_bounds, params_in_bounds, params_in_support, test_proba, params = _validate_coefficients(expr, pred, targ_low_prob, coeffs, thresh_none)
    assert coeffs_in_bounds is True
    assert params_in_bounds is True
    assert params_in_support is True
