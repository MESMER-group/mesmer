...
def estimate_and_superimpose_volcanic_influence(
    tas_residuals,
    tas_globmean_lowess,
    hist_period,
    *,
    ...
    """
    estimate volcanic influence on temperature residuals using aerosol optical depth
    observations as proxy and superimpose onto smooth temperature anomalies
    ...
    params = fit_volcanic_influence(
        tas_residuals, hist_period, dim=dim, version=version
    )

    return superimpose_volcanic_influence(
        tas_globmean_lowess, params, hist_period, dim=dim, version=version
    )
