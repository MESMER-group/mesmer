...
- Be welcoming to newcomers and encourage diverse new contributors from all backgrounds: see the `Python Community Code of Conduct <https://policies.python.org/python.org/code-of-conduct/>`_.
...
3. **Commit Changes**: Add and commit your changes with a clear and descriptive message.
   ...
   You can keep adding commits until you think your feature is ready to be merged. If you are unsure about how to write a good commit message, `here is a guide <https://cbea.ms/git-commit>`_.
...
- `Conda environments <https://www.freecodecamp.org/news/why-you-need-python-environments-and-how-to-manage-them-with-conda-85f155f4353c>`_
- `Tests <https://semaphore.io/community/tutorials/testing-python-applications-with-pytest>`_ - We use a blend of `pytest <https://docs.pytest.org/en/latest/>`_ and the inbuilt Python testing capabilities for our tests. Check out what we've already done in the ``tests/unit`` folder to get a feel for how it works.

- `Continuous integration (CI) <https://docs.travis-ci.com/user/for-beginners/>`_ - We use `GitHub actions <https://docs.github.com/en/actions/writing-workflows/quickstart>`_ for our CI, but there are a number of good options.
